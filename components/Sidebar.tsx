    ...
    <section className="py-6 space-y-6 border-t border-b border-slate-200 dark:border-slate-800/50">
      <div className="flex flex-col md:flex-row md:items-center md:space-x-4 space-y-4 md:space-y-0">
        ...
        <div className="flex space-x-2">
            <button onClick={onDiscover} className="flex-1 md:flex-initial flex items-center justify-center space-x-2 w-full px-4 py-3 bg-slate-200 dark:bg-slate-800/80 text-sm font-semibold text-slate-700 dark:text-slate-200 rounded-lg hover:bg-slate-300/80 dark:hover:bg-slate-700/80 transition-colors">
                <ShuffleIcon className="w-5 h-5" />
                <span>Discover</span>
            </button>
             <button onClick={onSubmit} className="flex-1 md:flex-initial flex items-center justify-center space-x-2 w-full px-4 py-3 bg-slate-200 dark:bg-slate-800/80 text-sm font-semibold text-slate-700 dark:text-slate-200 rounded-lg hover:bg-slate-300/80 dark:hover:bg-slate-700/80 transition-colors">
